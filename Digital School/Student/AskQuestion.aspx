<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AskQuestion.aspx.cs" Inherits="Digital_School.Student.AskQuestion" %>
	...
	<div class="row">
		...
		<div style="text-align:center" runat="server" id="divSuccess">
			<h3 class="text-success">
				Your question '<span runat="server" id="spanQuestion"></span>' has asked to '<span runat="server" id="spanTo"></span>' successfully.
			</h3>
			...
			<div class="col-sm-8">
				<div class="form-group">
					...
					<div class="col-md-10  col-sm-9">
						...
						<asp:RequiredFieldValidator CssClass="text-danger" ErrorMessage="Subject must not be empty." ControlToValidate="txtSubject"
							runat="server" />
					</div>
				</div>
			</div>
