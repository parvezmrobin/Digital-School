...
<div class="form-group">
	...
	<div class="col-md-6">
		<asp:TextBox ID="txt" CssClass="form-control" runat="server" TextMode="Number" >
		</asp:TextBox>
	</div>
	<asp:LinkButton Text="Submit" ID="btnSubmit" OnClick="btnSubmit_Click" CssClass="btn btn-info"
		runat="server" />
